...
frontend_auth_url="$(read_existing_value "$FRONTEND_ENV" "AUTH_URL" || printf '%s' "http://localhost:3000")"
frontend_auth_secret="$(read_existing_value "$FRONTEND_ENV" "AUTH_SECRET" || printf '%s' "change-me-local-secret")"
frontend_github_id="$(read_existing_value "$FRONTEND_ENV" "AUTH_GITHUB_ID" || printf '%s' "")"
frontend_github_secret="$(read_existing_value "$FRONTEND_ENV" "AUTH_GITHUB_SECRET" || printf '%s' "")"
