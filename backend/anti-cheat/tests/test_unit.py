...
class TestMaterialImbalance:
    ...
    def test_queen_capture_large_imbalance(self):
        ...
        board = chess.Board(fen="rnb1kbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2")
        # White has queen, black doesn't in an artificial position
        board2 = chess.Board(fen="rnb1kbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNB1KBNR w KQkq - 0 2")
