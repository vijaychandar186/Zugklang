          ...
          <Table>
            <TableHeader>
              <TableRow className='text-muted-foreground'>
                ...
                <TableHead className='py-1 text-center font-normal'>White</TableHead>
                <TableHead className='w-8 py-1 text-center font-normal'></TableHead>
                <TableHead className='py-1 text-center font-normal'>Black</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {CLASSIFICATION_LABELS.map(({ key, label }) => {
                ...
                return (
                  <TableRow key={key}>
                    ...
                    <TableCell className='py-1 text-center'>{whiteCount}</TableCell>
                    ...
                    <TableCell className='py-1 text-center'>{blackCount}</TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
