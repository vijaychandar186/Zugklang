...
_preload_explainers = os.environ.get("ANTI_CHEAT_PRELOAD_EXPLAINERS", "false").lower() == "true"
...
async def lifespan(app: FastAPI):
    ...
    if _preload_explainers:
        ...
        log.info("Skipping explainer preload at startup (ANTI_CHEAT_PRELOAD_EXPLAINERS=false).")
