...
import { Chess, type PieceSymbol } from '@/lib/chess/chess';
  ...
  useEffect(() => {
    ...
    fetch('/api/training/puzzle-rush', {
      ...
      body: JSON.stringify({
        ...
        score,
        mistakes,
        timeLimitSeconds: rushMode === 'timed' ? timeLimit * 60 : null,
        maxMistakes: rushMode === 'survival' ? maxMistakes : null
      })
    }).catch(() => {});
  }, [rushStatus, session?.user?.id, rushMode, difficulty, score, mistakes, timeLimit, maxMistakes]);
