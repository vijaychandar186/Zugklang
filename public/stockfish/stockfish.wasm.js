    ...
    ((a =
      t == ALLOC_NONE
        ...
        : [
            ...
            staticAlloc,
            dynamicAlloc
          ][void 0 === t ? ALLOC_STATIC : t](Math.max(i, u ? 1 : r.length))),
    o)
  ) {
    var s;
...
var ERRNO_CODES = {
  ...
  IDBFS = {
    ...
    getLocalSet: function (e, r) {
      ...
      for (
        var o = {}, i = FS.readdir(e.mountpoint).filter(t).map(n(e.mountpoint));
        i.length;
        ...
        (FS.isDir(a.mode) && i.push.apply(i, FS.readdir(u).filter(t).map(n(u))),
    ...
    mount: function (e) {
      function r(e) {
        for (var r = e.split('/'), t = n, i = 0; i < r.length - 1; i++) {
          ...
          (o[a] || (o[a] = WORKERFS.createNode(t, r[i], WORKERFS.DIR_MODE, 0)),
            (t = o[a]));
        }
        return t;
      }
...
var FS = {
    ...
    open: function (e, r, t, n, o) {
      ...
      if ((FS.isChrdev(i.mode) && (r &= -513), 65536 & r && !FS.isDir(i.mode)))
      ...
      if (
        ...
        ((r.canHandle = function (e) {
          ...
          (r.handle = function (e, r, t, n) {
            ...
            if (Browser.hasBlobConstructor)
              try {
                ((o = new Blob([e], { type: Browser.getMimetype(r) })),
                  o.size !== e.length &&
        ...
        ((t.canHandle = function (e) {
          ...
          (t.handle = function (e, r, t, n) {
            ...
            function i() {
              a ||
                ((a = !0), (Module.preloadedAudios[r] = new Audio()), n && n());
            }
            var a = !1;
